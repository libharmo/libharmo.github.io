...
public abstract class SDEntity implements Comparable<SDEntity> {
	...
	private int id;
	protected final refdiff.core2.rm2.model.SDModel.Snapshot snapshot;
	protected final String fullName;
	protected final refdiff.core2.rm2.model.EntityKey key;
	protected final refdiff.core2.rm2.model.SDContainerEntity container;
	protected final List<SDEntity> children;
	private refdiff.core2.rm2.model.MembersRepresentation members = null;
	
	public SDEntity(SDModel.Snapshot snapshot, int id, String fullName, refdiff.core2.rm2.model.EntityKey key, refdiff.core2.rm2.model.SDContainerEntity container) {
	...
	public refdiff.core2.rm2.model.EntityKey key() {
	  return key;
	}
	
	public refdiff.core2.rm2.model.EntityKey key(SDEntity parent) {
...
//		return fullName.hashCode();
	...
	public refdiff.core2.rm2.model.MembersRepresentation membersRepresentation() {
