...
public class SDModel {
	...
	public interface Snapshot {
		...
		refdiff.core2.rm2.model.SDPackage getOrCreatePackage(String fullName, String sourceFolder);

		SDType createType(String typeName, refdiff.core2.rm2.model.SDContainerEntity container, String sourceFilePath);

		refdiff.core2.rm2.model.SDMethod createMethod(String methodSignature, refdiff.core2.rm2.model.SDContainerEntity container, boolean isConstructor);

		SDAttribute createAttribute(String attributeName, refdiff.core2.rm2.model.SDContainerEntity container);

		SDType createAnonymousType(refdiff.core2.rm2.model.SDContainerEntity peek, String sourceFilePath, String localName);

		Set<SDType> getUnmatchedTypes();

        Set<refdiff.core2.rm2.model.SDMethod> getUnmatchedMethods();
	...
	private class SnapshotImpl implements Snapshot {
	    ...
	    private final Set<refdiff.core2.rm2.model.SDMethod> unmatchedMethods = new TreeSet<refdiff.core2.rm2.model.SDMethod>();
        ...
        public Set<refdiff.core2.rm2.model.SDMethod> getUnmatchedMethods() {
        ...
        public refdiff.core2.rm2.model.SDPackage getOrCreatePackage(String fullName, String sourceFolder) {
			EntityKey key = new EntityKey(sourceFolder + fullName);
      refdiff.core2.rm2.model.SDPackage p = find(refdiff.core2.rm2.model.SDPackage.class, key);
			if (p == null) {
		...
		public SDType createType(String typeName, refdiff.core2.rm2.model.SDContainerEntity container, String sourceFilePath) {
		...
		public SDType createAnonymousType(refdiff.core2.rm2.model.SDContainerEntity container, String sourceFilePath, String localName) {
		...
		public refdiff.core2.rm2.model.SDMethod createMethod(String methodSignature, refdiff.core2.rm2.model.SDContainerEntity container, boolean isConstructor) {
		  EntityKey key = new EntityKey(container.key() + "#" + methodSignature);
			refdiff.core2.rm2.model.SDMethod sdMethod = new SDMethod(this, getId(), methodSignature, container, isConstructor);
...
//	EntitySet<SDMethod> extractedMethods = new EntitySet<SDMethod>();
	List<refdiff.core2.rm2.model.refactoring.SDRefactoring> refactorings = new ArrayList<refdiff.core2.rm2.model.refactoring.SDRefactoring>();
	...
	public void addRefactoring(refdiff.core2.rm2.model.refactoring.SDRefactoring ref) {
