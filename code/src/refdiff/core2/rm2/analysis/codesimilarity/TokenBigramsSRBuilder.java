...
class TokenBigramsSRBuilder implements SourceRepresentationBuilder {
    ...
    public refdiff.core2.rm2.analysis.codesimilarity.TokenBigramsSR buildSourceRepresentation(char[] charArray, int start, int length) {
        ...
        return new refdiff.core2.rm2.analysis.codesimilarity.TokenBigramsSR(computeBigrams(lines), debug);
    }

    @Override
    public refdiff.core2.rm2.analysis.codesimilarity.TokenBigramsSR buildEmptySourceRepresentation() {
        return new refdiff.core2.rm2.analysis.codesimilarity.TokenBigramsSR(new long[0]);
    }
