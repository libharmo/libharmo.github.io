...
public class RefDiffConfigImpl implements refdiff.core2.rm2.analysis.RefDiffConfig {
    ...
    private refdiff.core2.rm2.analysis.codesimilarity.CodeSimilarityStrategy codeSimilarityStrategy = refdiff.core2.rm2.analysis.codesimilarity.CodeSimilarityStrategy.TFIDF;
    ...
    @Override
    public refdiff.core2.rm2.analysis.codesimilarity.CodeSimilarityStrategy getCodeSimilarityStrategy() {
