...
import refdiff.core2.rm2.model.refactoring.*;
...
public class RefactoringDetector {
    ...
    private void identifyMatchingTypes(SDModel m) {
        new TypeMatcher()
            .addCriterion(new EntityMatcher.Criterion<SDType>(RelationshipType.MOVE_TYPE, config.getThreshold(RelationshipType.MOVE_TYPE)) {
            ...
            .addCriterion(new EntityMatcher.Criterion<SDType>(RelationshipType.RENAME_TYPE, config.getThreshold(RelationshipType.RENAME_TYPE)) {
                protected boolean canMatch(SDModel m, SDType entityBefore, SDType entityAfter) {
            ...
            .addCriterion(new EntityMatcher.Criterion<SDType>(RelationshipType.MOVE_AND_RENAME_TYPE, config.getThreshold(RelationshipType.MOVE_AND_RENAME_TYPE)) {
                protected boolean canMatch(SDModel m, SDType entityBefore, SDType entityAfter) {
                    return !entityBefore.simpleName().equals(entityAfter.simpleName()) &&
    ...
    private void identifyMatchingMethods(SDModel m) {
        new MethodMatcher()
            .addCriterion(new EntityMatcher.Criterion<SDMethod>(RelationshipType.CHANGE_METHOD_SIGNATURE, config.getThreshold(RelationshipType.CHANGE_METHOD_SIGNATURE)) {
            ...
            .addCriterion(new EntityMatcher.Criterion<SDMethod>(RelationshipType.RENAME_METHOD, config.getThreshold(RelationshipType.RENAME_METHOD)) {
                protected boolean canMatch(SDModel m, SDMethod methodBefore, SDMethod methodAfter) {
                    return !methodBefore.identifier().equals(methodAfter.identifier()) &&
                        !methodBefore.isAbstract() && !methodAfter.isAbstract() &&
                        m.entitiesMatch(methodBefore.container(), methodAfter.container());
            ...
            .addCriterion(new EntityMatcher.Criterion<SDMethod>(RelationshipType.PULL_UP_METHOD, config.getThreshold(RelationshipType.PULL_UP_METHOD)) {
                protected boolean canMatch(SDModel m, SDMethod methodBefore, SDMethod methodAfter) {
                    return methodBefore.identifier().equals(methodAfter.identifier()) &&
                        !methodBefore.isAbstract() && !methodAfter.isAbstract() &&
            ...
            .addCriterion(new EntityMatcher.Criterion<SDMethod>(RelationshipType.PUSH_DOWN_METHOD, config.getThreshold(RelationshipType.PUSH_DOWN_METHOD)) {
                protected boolean canMatch(SDModel m, SDMethod methodBefore, SDMethod methodAfter) {
                    return methodBefore.identifier().equals(methodAfter.identifier()) &&
                        !methodBefore.isAbstract() && !methodAfter.isAbstract() &&
                        !methodBefore.isConstructor() && !methodAfter.isConstructor() &&
            ...
            .addCriterion(new EntityMatcher.Criterion<SDMethod>(RelationshipType.MOVE_METHOD, config.getThreshold(RelationshipType.MOVE_METHOD)) {
                protected boolean canMatch(SDModel m, SDMethod methodBefore, SDMethod methodAfter) {
                    return methodBefore.identifier().equals(methodAfter.identifier()) &&
                        !methodBefore.isAbstract() && !methodAfter.isAbstract() &&
                        !methodBefore.isConstructor() && !methodAfter.isConstructor() &&
    ...
    private void identifyMatchingAttributes(SDModel m) {
        new AttributeMatcher()
            .addCriterion(new EntityMatcher.Criterion<SDAttribute>(RelationshipType.PULL_UP_FIELD, config.getThreshold(RelationshipType.PULL_UP_FIELD)) {
            ...
            .addCriterion(new EntityMatcher.Criterion<SDAttribute>(RelationshipType.PUSH_DOWN_FIELD, config.getThreshold(RelationshipType.PUSH_DOWN_FIELD)) {
                protected boolean canMatch(SDModel m, SDAttribute attributeBefore, SDAttribute attributeAfter) {
                    return attributeBefore.simpleName().equals(attributeAfter.simpleName()) &&
                        attributeBefore.type().equals(attributeAfter.type()) &&
                        m.existsAfter(attributeBefore.container()) &&
            ...
            .addCriterion(new EntityMatcher.Criterion<SDAttribute>(RelationshipType.MOVE_FIELD, config.getThreshold(RelationshipType.MOVE_FIELD)) {
                protected boolean canMatch(SDModel m, SDAttribute attributeBefore, SDAttribute attributeAfter) {
                    return attributeBefore.simpleName().equals(attributeAfter.simpleName()) &&
                        attributeBefore.type().equals(attributeAfter.type());
                }
