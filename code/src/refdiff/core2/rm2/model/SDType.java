...
public class SDType extends refdiff.core2.rm2.model.SDContainerEntity {
	...
	private refdiff.core2.rm2.model.EntitySet<SDType> subtypes = new refdiff.core2.rm2.model.EntitySet<SDType>();
	...
	private refdiff.core2.rm2.model.SourceRepresentation source;
	private int nestingLevel;
	private refdiff.core2.rm2.model.Multiset<SDType> origins;
	private refdiff.core2.rm2.model.Multiset<SDType> referencedBy;
	
	public SDType(refdiff.core2.rm2.model.SDModel.Snapshot snapshot, int id, String simpleName, refdiff.core2.rm2.model.SDContainerEntity container, String sourceFilePath) {
	...
	private SDType(refdiff.core2.rm2.model.SDModel.Snapshot snapshot, int id, String anonymousId, SDType container, String sourceFilePath, boolean localType) {
	...
	private SDType(SDModel.Snapshot snapshot, int id, String simpleName, String fullName, EntityKey key, SDContainerEntity container, String sourceFilePath, boolean isAnonymous, boolean localType) {
	    ...
	    this.origins = new refdiff.core2.rm2.model.Multiset<SDType>();
	    this.referencedBy = new refdiff.core2.rm2.model.Multiset<SDType>();
	}
	...
	public refdiff.core2.rm2.model.SourceRepresentation sourceCode() {
        return this.source;
    }
	...
	public refdiff.core2.rm2.model.Multiset<SDType> origins() {
        return this.origins;
    }
