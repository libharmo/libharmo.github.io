...
import refdiff.core2.rm2.model.Multiset;
...
class TokenIdfSR implements SourceRepresentation {
    ...
    private final refdiff.core2.rm2.analysis.codesimilarity.TokenIdfSRBuilder builder;

    public TokenIdfSR(Multiset<String> tokens, refdiff.core2.rm2.analysis.codesimilarity.TokenIdfSRBuilder builder) {
        this.tokens = tokens;
